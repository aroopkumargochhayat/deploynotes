...
class AssignmentController extends Controller
{
    ...
    public function index()
    {
        $assignments = Assignment::select('*','assignments.id AS id')
                            ...
                            ->join('chapters','chapters.id','=','assignments.chapter_id')
...
//            'deadline' => 'required|date',
            ...
            'file_2' => 'nullable|mimes:jpg,jpeg,png',
            'file_3' => 'nullable|mimes:jpg,jpeg,png',
            'file_4' => 'nullable|mimes:jpg,jpeg,png',
        ]);
