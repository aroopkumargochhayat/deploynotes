...
Route::group(['middleware' => ['install']], function () {	
	...
	Route::group(['middleware' => ['auth']], function () {
		...
		Route::group(['middleware' => ['permission']], function () {
			...
			Route::get('students/get_subjects/{class_id}', 'StudentController@get_subjects');		Route::get('students/get_students/{class_id}/{section_id}', 'StudentController@get_students');
			...
			Route::resource('subjects','SubjectController');
                        ...
                        //Chapter Route
			Route::get('chapters/subject/{subject_id}', 'ChapterController@index')->name('chapters.index');
			Route::post('chapters/chapter', 'ChapterController@get_chapter');
